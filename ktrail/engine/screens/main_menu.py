...
class MainMenu(QWidget):
    ...
    def init_ui(self):
        ...
        self.leaderboard_button = self.create_button("Таблица рекордов", self.open_leaderboard, x=125, y=580, w=550, h=55)
        self.settings_button = self.create_button("Настройки", self.open_settings, x=125, y=660, w=550, h=55)
        self.exit_button = self.create_button("Выход", self.exit_game, x=125, y=740, w=550, h=55)
